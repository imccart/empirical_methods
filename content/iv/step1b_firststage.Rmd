...
The result of these tests, for the purposes of weak IV robust inference, is a range of values such that the null $H_{0}: \beta_{1}=b$ cannot be rejected (at the given significance level used to construct the interval).
