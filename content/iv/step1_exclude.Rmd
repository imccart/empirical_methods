...
You can go a little further with this, as shown in @altonji2005, and use this approach to directly estimate the extent of the bias from violations of the exclusion restriction. However, a more recent approach to deal with violations of the exclusion restriction is in @conley2012 and @kippersluis2018, which I discuss in more detail in [Step 1B: Violations of the exclusion restriction](step1b_exclude).
