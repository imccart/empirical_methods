...
Regardless, the exclusion restriction is hard to test because the instrument should also be correlated with the endogenous variable. If you have an overidentified model, then you can test the exclusion restriction alongside the exogeneity assumption for a subset of instruments. 
